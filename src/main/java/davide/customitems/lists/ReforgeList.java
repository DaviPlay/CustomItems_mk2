...
public class ReforgeList {
    ...
    //Armor
    public static final Reforge refreshing = new Reforge("Refreshing", Type.ARMOR, 5, 0, 0, 2, 0);
    public static final Reforge Healthy = new Reforge("Healthy", Type.ARMOR, 10, 0, 0, 4, 0);
